...
|---|---|---|---|---|---|
| **CAGR** | **24.1%** | 15.9% | 10.0% | 16.6% | 19.9% |
| **Max Drawdown** | **-51.8%** | -96.2% | -54.6% | -83.2% | -46.5% |
| **Sharpe Ratio** | **0.66** | 0.45 | 0.34 | 0.47 | 0.56 |
| **Sortino Ratio** | **0.54** | 0.44 | 0.32 | 0.45 | 0.42 |
| **Calmar Ratio** | **0.46** | 0.17 | 0.18 | 0.20 | 0.43 |
| **Ulcer Index** | 0.218 | 0.501 | 0.151 | 0.314 | 0.183 |
| **UPI** | 0.86 | 0.21 | 0.32 | 0.36 | 0.80 |
| **Worst 1-yr Return** | -51.3% | -90.9% | -45.6% | -75.5% | -35.8% |
| **Worst 3-yr Return** | -46.4% | -90.8% | -43.1% | -74.3% | -29.6% |
| **% 3yr Negative** | 6.2% | 26.1% | 18.6% | 22.1% | 5.6% |
| **Recovery (weeks)** | 177 | 407 | 180 | 219 | 22 |
| **Total Return** | **682.7x** | 86.3x | 18.0x | 104.7x | 135.6x |
| **Trades** | 48 | 0 | 0 | 0 | 136 |
| **% Time in Equities** | 70% | 100% | 100% | 100% | 52% |
| **Train CAGR (pre-2017)** | 22.6% | 12.2% | 8.3% | 12.8% | 10.9% |
| **Test CAGR (2017+)** | 26.8% | 24.0% | 14.0% | 25.5% | 38.2% |
| **Train Sharpe** | 0.63 | 0.39 | 0.25 | 0.38 | 0.33 |
| **Test Sharpe** | 0.72 | 0.59 | 0.55 | 0.69 | 0.90 |
| **Train/Test Sharpe Ratio** | **0.88** | 0.66 | 0.45 | 0.55 | 0.37 |
...
| **65w** | **SMA10** | **22%** | **24.1%** | **-51.8%** | **0.66** | **0.46** | **0.88** |
...
4. **Train/Test robustness is excellent.** The winner has Train CAGR 22.6%, Test CAGR 26.8%. Train Sharpe 0.63, Test Sharpe 0.72. Train/Test Sharpe ratio of 0.88 indicates genuine edge, not overfit.
...
- Test (2017-present): CAGR 26.8%, Sharpe 0.72, MaxDD -40.1%
- Train/Test Sharpe Ratio: 0.88
...
| **Trades** | 136 over 23yr (~6/yr) | 48 over 30yr (~1.6/yr) | Fewer, higher-quality signals. |
| **Time in market** | 52% | **70%** | Shorter regime catches crashes but stays in longer during bulls. |
| **CAGR** | 19.9% | **24.1%** | Higher market exposure (70% vs 52%) compounds more aggressively. |
| **Max DD** | -46.5% | -51.8% | Slightly wider drawdown; acceptable given the CAGR premium. |
| **Sharpe** | 0.56 | **0.66** | Better risk-adjusted returns. |
| **Calmar** | 0.43 | **0.46** | Better return per unit of drawdown. |
| **Walk-forward consistency** | Not tested identically | **1.54** | All periods positive Sharpe. |
| **Train/Test Sharpe Ratio** | 0.37 | **0.88** | Much more robust out-of-sample. |
